...
@section('content')
    <div class="bg-gradient-to-br from-white to-pink-50 min-h-screen">
        ...
        <!-- Error Message -->
        <div id="errorMessage"
            class="hidden fixed top-4 right-4 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded z-50">
            ...
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div class="relative">
                    ...
                    <div class="bg-white rounded-lg p-8 shadow-md mb-4">
                        <img src="{{ asset('images/products/serum-main.avif') }}" alt="Personalized Serum" class="w-full"
                            id="mainImage" onerror="this.src='{{ asset('images/products/serum-main.png') }}'">
                        <button class="absolute right-12 bottom-12 bg-white rounded-full p-2 shadow-md"
                    ...
                    <!-- Navigation Arrows -->
                    <button class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md"
                        onclick="changeImage(-1)">
                        <i class="fas fa-chevron-left text-gray-600"></i>
                    </button>
                    <button class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 shadow-md"
                        onclick="changeImage(1)">
                ...
                <div>
                        ...
                        <div class="flex items-center space-x-4 mb-4">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <input type="number" name="quantity" value="1" min="1" max="10"
                                    class="w-16 text-center border rounded-lg" id="quantityInput">
                                <button type="button"
                                    class="w-8 h-8 flex items-center justify-center border rounded-full hover:bg-gray-100"
                    ...
                    <div class="space-y-4 mb-8">
                        <button
                            class="w-full bg-pink-100 text-pink-600 py-3 rounded-full hover:bg-pink-200 transition-colors"
                            onclick="addToCart('{{ $customProduct->custom_product_id }}')">
                            <i class="fas fa-shopping-cart mr-2"></i>Add to Cart
                        </button>
                        <button
                            class="w-full bg-amber-500 text-white py-3 rounded-full hover:bg-amber-600 transition-colors"
                            onclick="buyNow('{{ $customProduct->custom_product_id }}')">
                        ...
                        <ul class="list-disc list-inside text-gray-600 space-y-2">
                            @foreach($productDetails['selected_ingredients'] as $index => $ingredient)
                                <li class="mb-2">
                                    ...
                                    <span
                                        class="block text-sm ml-4 text-gray-500">{{ $productDetails['benefits'][$index] ?? '' }}</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                            ...
                            <div class="p-4 border-t">
                                ...
                                <ul class="text-sm space-y-1">
                                    @foreach($productDetails['selected_ingredients'] as $ingredient)
                                        <li>{{ ucwords(str_replace('_', ' ', $ingredient)) }}
                                            ({{ number_format($productDetails['concentrations'][$ingredient] * 100, 1) }}%)</li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            console.log('Functions loaded:', {
                addToCart: typeof window.addToCart || typeof addToCart,
                buyNow: typeof window.buyNow || typeof buyNow,
